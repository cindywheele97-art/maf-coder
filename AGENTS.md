...
This file is loaded by AI coding agents (Cursor, Claude Code, etc.) at the start of every session for this project. It is the project-level operating manual for any agent working in this codebase.
